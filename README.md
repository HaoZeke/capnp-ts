...
| RPC levels 1-4 | no | L1-L2 (no L4) | L1-L2 (no L4) | L1-L4 | **L1-L4** (`@haozeke/capnp-rpc`; L3 both halves, hosting and vines, over `rpc-threeparty.capnp`; L4 `Join`, which upstream C++ lacks) |
